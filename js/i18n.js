...
const I18N = {
  ar: {
    ...
    compassNoHeading: "تعذّر قراءة اتجاه الشمال على هذا الجهاز. حرّك الجهاز على شكل ∞ لمعايرة البوصلة، أو استعمل الزاوية بالدرجات أعلاه.",
  ...
  en: {
    ...
    compassNoHeading: "Couldn't read true north on this device. Move your phone in a figure-8 to calibrate, or use the degree bearing above.",
